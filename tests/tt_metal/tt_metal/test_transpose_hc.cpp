...
int main(int argc, char **argv) {
    ...
    try {
        ...
        tt_metal::SetRuntimeArgs(program, reader_kernel, core, {dram_buffer_src0_addr, 0, W, H, C, HW, N, CHW});

        tt_metal::SetRuntimeArgs(program, unary_writer_kernel, core, {dram_buffer_dst_addr, 0, num_tensor_tiles});
