...
PermuteDeviceOperation::SingleCore::cached_program_t PermuteDeviceOperation::SingleCore::create(
    ...
    std::vector<uint32_t> input_shape_vector = input_tensor.get_logical_shape().as_vector();
    ...
    writer_runtime_args.insert(writer_runtime_args.end(), input_shape_vector.begin(), input_shape_vector.end());
