...
tt::stl::hash::hash_t BinaryNgDeviceOperation::operation_attributes_t::to_hash() const {
    return tt::stl::hash::hash_objects_with_default_seed(
        binary_op_type, memory_config, dtype, compute_kernel_config, subtile_broadcast_type);
}
...
BinaryNgDeviceOperation::spec_return_value_t BinaryNgDeviceOperation::compute_output_specs(
    ...
    return TensorSpec(output_shape, TensorLayout(attributes.dtype, PageConfig(Layout::TILE), attributes.memory_config));
}
