...
inline Tensor create_tensor_from_buffer(
    ...
    switch (dtype) {
        ...
        case DataType::BFLOAT4_B: {
            ...
            auto tensor = Tensor(OwnedStorage{std::move(buffer)}, shape, DataType::FLOAT32, Layout::ROW_MAJOR)
                              .to(Layout::TILE);
            ...
            return Tensor(OwnedStorage{std::move(output_buffer)}, shape, dtype, Layout::TILE); // has to be in tile layout
        }
        default: {
