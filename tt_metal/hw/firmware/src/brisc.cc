...
int main() {
    ...
    //DPRINT << "DRAM noc_xy[0][0] = " << dram_bank_to_noc_xy[0][0] <<ENDL();
    //DPRINT << "DRAM noc_xy[0][1] = " << dram_bank_to_noc_xy[0][1] <<ENDL();
    //DPRINT << "DRAM noc_xy[0][last] = " << dram_bank_to_noc_xy[0][NUM_DRAM_BANKS-1] <<ENDL();
    //DPRINT << "DRAM noc_xy[0][last-1] = " << dram_bank_to_noc_xy[0][NUM_DRAM_BANKS-2] <<ENDL();

    //DPRINT << "DRAM noc_xy[1][0] = " << dram_bank_to_noc_xy[1][0] <<ENDL();
    //DPRINT << "DRAM noc_xy[1][1] = " << dram_bank_to_noc_xy[1][1] <<ENDL();
    //DPRINT << "DRAM noc_xy[1][last] = " << dram_bank_to_noc_xy[1][NUM_DRAM_BANKS-1] <<ENDL();
    //DPRINT << "DRAM noc_xy[1][last-1] = " << dram_bank_to_noc_xy[1][NUM_DRAM_BANKS-2] <<ENDL();

    //DPRINT << "l1 noc_xy[0][0] = " << l1_bank_to_noc_xy[0][0] <<ENDL();
    //DPRINT << "l1 noc_xy[0][1] = " << l1_bank_to_noc_xy[0][1] <<ENDL();
    //DPRINT << "l1 noc_xy[0][last] = " << l1_bank_to_noc_xy[0][NUM_L1_BANKS-1] <<ENDL();
    //DPRINT << "l1 noc_xy[0][last-1] = " << l1_bank_to_noc_xy[0][NUM_L1_BANKS-2] <<ENDL();

    //DPRINT << "l1 noc_xy[1][0] = " << l1_bank_to_noc_xy[1][0] <<ENDL();
    //DPRINT << "l1 noc_xy[1][1] = " << l1_bank_to_noc_xy[1][1] <<ENDL();
    //DPRINT << "l1 noc_xy[1][last] = " << l1_bank_to_noc_xy[1][NUM_L1_BANKS-1] <<ENDL();
    //DPRINT << "l1 noc_xy[1][last-1] = " << l1_bank_to_noc_xy[1][NUM_L1_BANKS-2] <<ENDL();

    //DPRINT << "dram_offset [0] = " << bank_to_dram_offset[0] <<ENDL();
    //DPRINT << "dram_offset [1] = " << bank_to_dram_offset[1] <<ENDL();
    //DPRINT << "dram_offset [last] = " << bank_to_dram_offset[NUM_DRAM_BANKS-1] <<ENDL();
    //DPRINT << "dram_offset [last-1] = " << bank_to_dram_offset[NUM_DRAM_BANKS-2] <<ENDL();

    //DPRINT << "l1_offset [0] = " << bank_to_l1_offset[0] <<ENDL();
    //DPRINT << "l1_offset [2] = " << bank_to_l1_offset[2] <<ENDL();
    //DPRINT << "l1_offset [last-17] = " << bank_to_l1_offset[NUM_L1_BANKS-18] <<ENDL();
    //DPRINT << "l1_offset [last-1] = " << bank_to_l1_offset[NUM_L1_BANKS-2] <<ENDL();
