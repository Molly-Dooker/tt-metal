...
void init_compute_and_storage_l1_bank_manager(Allocator &allocator, const AllocatorConfig &alloc_config) {
    ...
    uint32_t storage_core_unreserved_base = ((MEM_MAILBOX_BASE + alloc_config.l1_alignment - 1) / alloc_config.l1_alignment) * alloc_config.l1_alignment;
    ...
    allocator.l1_manager = BankManager(BufferType::L1, bank_id_to_bank_offset, allocatable_l1_size, interleaved_address_limit, alloc_config.l1_alignment, alloc_config.l1_unreserved_base);
