...
// TODO: nhuang - Below repeated constexpr code in the dispatch kernels can be condensed by using preprocessor macros
...
static_assert(is_power_of_2(remote_receiver_queue_size_words[0]), "remote_receiver_queue_size_words[0] must be a power of 2");
static_assert(is_power_of_2(remote_receiver_queue_size_words[1]), "remote_receiver_queue_size_words[1] must be a power of 2");
static_assert(is_power_of_2(remote_receiver_queue_size_words[2]), "remote_receiver_queue_size_words[2] must be a power of 2");
static_assert(is_power_of_2(remote_receiver_queue_size_words[3]), "remote_receiver_queue_size_words[3] must be a power of 2");
static_assert(is_power_of_2(remote_receiver_queue_size_words[4]), "remote_receiver_queue_size_words[4] must be a power of 2");
static_assert(is_power_of_2(remote_receiver_queue_size_words[5]), "remote_receiver_queue_size_words[5] must be a power of 2");
static_assert(is_power_of_2(remote_receiver_queue_size_words[6]), "remote_receiver_queue_size_words[6] must be a power of 2");
static_assert(is_power_of_2(remote_receiver_queue_size_words[7]), "remote_receiver_queue_size_words[7] must be a power of 2");
static_assert(is_power_of_2(remote_receiver_queue_size_words[8]), "remote_receiver_queue_size_words[8] must be a power of 2");
static_assert(is_power_of_2(remote_receiver_queue_size_words[9]), "remote_receiver_queue_size_words[9] must be a power of 2");
...
// VC eth tunneler Inputs
constexpr uint32_t vc_eth_tunneler_in_local_wptr_addr[MAX_TUNNEL_LANES] = {
...
constexpr uint32_t vc_eth_tunneler_in_remote_rptr_sent_addr[MAX_TUNNEL_LANES] = {
...
constexpr uint32_t vc_eth_tunneler_in_remote_rptr_cleared_addr[MAX_TUNNEL_LANES] = {
...
// VC eth tunneler outputs
constexpr uint32_t vc_eth_tunneler_out_local_rptr_sent_addr[MAX_TUNNEL_LANES] = {
...
constexpr uint32_t vc_eth_tunneler_out_local_rptr_cleared_addr[MAX_TUNNEL_LANES] = {
    get_compile_time_arg_val(88),
    get_compile_time_arg_val(89),
    get_compile_time_arg_val(90),
    get_compile_time_arg_val(91),
    get_compile_time_arg_val(92),
    get_compile_time_arg_val(93),
    get_compile_time_arg_val(94),
    get_compile_time_arg_val(95),
    get_compile_time_arg_val(96),
    get_compile_time_arg_val(97)};

constexpr uint32_t vc_eth_tunneler_out_remote_wptr_addr[MAX_TUNNEL_LANES] = {
    get_compile_time_arg_val(98),
    get_compile_time_arg_val(99),
    get_compile_time_arg_val(100),
    get_compile_time_arg_val(101),
    get_compile_time_arg_val(102),
    get_compile_time_arg_val(103),
    get_compile_time_arg_val(104),
    get_compile_time_arg_val(105),
    get_compile_time_arg_val(106),
    get_compile_time_arg_val(107)};
...
void kernel_main() {
    ...
    write_buffer_to_l1(kernel_status, PQ_TEST_MISC_INDEX + 2, 0xAABBCCDD);
    write_buffer_to_l1(kernel_status, PQ_TEST_MISC_INDEX + 3, 0xDDCCBBAA);
    write_buffer_to_l1(kernel_status, PQ_TEST_MISC_INDEX + 4, endpoint_id_start_index);
    ...
    for (uint32_t i = 0; i < tunnel_lanes; i++) {
        input_queues[i].init(
            ...
            vc_eth_tunneler_in_local_wptr_addr[i],
            vc_eth_tunneler_in_remote_rptr_sent_addr[i],
            vc_eth_tunneler_in_remote_rptr_cleared_addr[i]);
    }
    ...
    for (uint32_t i = 0; i < tunnel_lanes; i++) {
        output_queues[i].init(
            ...
            &input_queues[i],
            1,
            vc_eth_tunneler_out_local_rptr_sent_addr[i],
            vc_eth_tunneler_out_local_rptr_cleared_addr[i],
            vc_eth_tunneler_out_remote_wptr_addr[i]);
    }
    ...
    write_buffer_to_l1(kernel_status, PQ_TEST_MISC_INDEX, 0xff000001);
            ...
            if (switch_counter >= SWITCH_THRESHOLD) {
                ...
                if (output_finished) {
                    ...
                    if ((i == return_vc) && (inner_stop_mux_d_bypass != 0)) {
                        ...
                        input_queues[i].remote_ready_status_addr = ((inner_stop_mux_d_bypass >> 16) & 0xFF);
                    }
    ...
    // write_buffer_to_l1(kernel_status, PQ_TEST_MISC_INDEX, 0xff000002);
    for (uint32_t i = 0; i < tunnel_lanes; i++) {
