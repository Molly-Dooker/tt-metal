...
class _OSA_module(nn.Module):
    def __init__(
        ...
        print("in_ch: ", in_ch)
        print("stage_ch: ", stage_ch)
        print("concat_ch: ", concat_ch)
        print("layer_per_block: ", layer_per_block)
        print("module_name: ", module_name)
        print("SE: ", SE)
        print("identity: ", identity)
        print("depthwise: ", depthwise)
        print("with_cp: ", with_cp)
    ...
    def forward(self, x):
        ...
        print("self.use_checkpoint: ", self.use_checkpoint)
...
class VoVNetCP(torch.nn.Module):
    ...
    def forward(self, x):
        # print("VOVNETCP self.init_cfg: ", self.init_cfg)
        # print("self.spec_name: ", self.spec_name)
        # print("self.input_ch: ", self.input_ch)
        # print("self.out_features: ", self.out_features)
        # print("self.pretrained: ", self.pretrained)
        # print("self.frozen_stages: ", self.frozen_stages)
        # print("self.norm_eval: ", self.norm_eval)

        # print("stage_specs: ", self.stage_specs)
        outputs = []
        x = self.stem(x)
        if "stem" in self._out_features:
            outputs.append(x)
